...
# 4. Copy or create new ssh creds for the Rasp Pi.  From host: `scp -r ~/.ssh james@192.168.1.12:/home/james/`
# 5. SSH in and do the rest of this.
...
source venv/bin/activate \
    && pip3 install --upgrade attrs adafruit-python-shell adafruit-circuitpython-pm25 \
